...
const RealEstateAgentVoice: React.FC<RealEstateAgentVoiceProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (validateForm() && selectedAgent && handleStart) {
      try {
        ...
        console.log("start-thunder API call succeeded, setting showForm to false");
        ...
        setFormErrors((prev) => ({ ...prev, phone: "Failed to connect to agent. Please try again." }));
      }
    } else {
      console.log("Form validation failed or missing selectedAgent/handleStart");
    }
  };
  ...
  console.log("Rendering RealEstateAgentVoice, showForm:", showForm, "agentName:", agentName);
      ...
      {showForm ? (
        <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full transform transition-all duration-300 scale-95 hover:scale-100 fade-in">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-orange-600">Get Started with {selectedAgent?.title}</h2>
            <button
              onClick={handleClose}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 rounded-lg border-2 ${formErrors.name ? "border-red-500" : "border-orange-200"} focus:border-orange-500 focus:ring-2 focus:ring-orange-300 outline-none transition-all bg-orange-50 text-gray-800 placeholder-gray-400`}
            ...
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                className={`w-full px-4 py-2 rounded-lg border-2 ${formErrors.email ? "border-red-500" : "border-orange-200"} focus:border-orange-500 focus:ring-2 focus:ring-orange-300 outline-none transition-all bg-orange-50 text-gray-800 placeholder-gray-400`}
            ...
            <div>
              ...
              <PhoneInput
                ...
                inputProps={{
                  name: "phone",
                  id: "phone",
                  className: `w-full px-4 py-2 rounded-lg border-2 ${formErrors.phone ? "border-red-500" : "border-orange-200"} focus:border-orange-500 focus:ring-2 focus:ring-orange-300 outline-none transition-all bg-orange-50 text-gray-800 placeholder-gray-400 pl-12`,
                }}
              />
